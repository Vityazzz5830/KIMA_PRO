...
$('.projectssec-content-list-mobile').slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    arrows: false,
    fade: false,
...
const btn1 = document.getElementsByClassName('header_content-wrap-navmenu-righpart-list-item-1')[0];
const btn2 = document.getElementsByClassName('header_content-wrap-navmenu-righpart-list-item-2')[0];
const btn3 = document.getElementsByClassName('header_content-wrap-navmenu-righpart-list-item-3')[0];
const btn4 = document.getElementsByClassName('header_content-wrap-navmenu-righpart-list-item-4')[0];
const btn5 = document.getElementsByClassName('header_content-wrap-navmenu-righpart-list-item-5')[0];        
